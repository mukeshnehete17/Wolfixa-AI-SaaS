...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0B0B0F] flex flex-col font-sans">
      ...
      <nav className="absolute top-0 w-full p-6 z-50 flex items-center justify-between max-w-7xl mx-auto left-0 right-0">
        <Link href="/dashboard" className="flex items-center gap-3 group transition-transform active:scale-95">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-[#6C3BEA] to-[#9D72FF] shadow-[0_0_15px_rgba(108,59,234,0.3)] group-hover:shadow-[0_0_20px_rgba(108,59,234,0.6)] transition-all">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[40%] h-[40%] bg-[#6C3BEA]/20 blur-[150px] rounded-full pointer-events-none" style={{ willChange: 'transform' }} />
      <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] bg-[#9D72FF]/20 blur-[150px] rounded-full pointer-events-none" style={{ willChange: 'transform' }} />
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/login" className="w-full sm:w-auto" onClick={() => setIsNavigating(true)}>
              <button disabled={isNavigating} className="w-full sm:w-auto min-w-[240px] glow-button bg-gradient-to-r from-[#6C3BEA] to-[#804dfa] text-white px-8 py-4 rounded-xl font-medium flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(108,59,234,0.3)] disabled:opacity-80">
                {isNavigating ? (
